...
insert into admin_item (admin_item_typ_id, NCI_iDSEQ, ITEM_DESC, ITEM_NM, ITEM_LONG_NM,  VER_NR, CNTXT_NM_DN,CREAT_USR_ID, CREAT_DT, LST_UPD_DT,LST_UPD_USR_ID)
select 8, trim(conte_idseq), description, name,name,version, name,
...
insert into admin_item(item_id, ver_nr, nci_idseq, admin_item_typ_id, ITEM_LONG_NM,ITEM_DESC,ITEM_NM)
values (-20000, 1,'1',5,'Default Object Class','Default Object Class', 'Default Object Class');
commit;
insert into admin_item(item_id, ver_nr, nci_idseq, admin_item_typ_id, ITEM_LONG_NM,ITEM_DESC,ITEM_NM)
values (-20001, 1,'2', 6,'Default Property','Default Property', 'Default Property');
commit;
...
insert into admin_item (item_id, ver_nr, admin_item_typ_id, item_nm,  ITEM_LONG_NM,ITEM_DESC)
values (-20002,1,5,'Default CD', 'Default CD',  'Default CD');
commit;
...
insert into admin_item (item_id, ver_nr, admin_item_typ_id, item_nm, ITEM_LONG_NM)
values (-20003,1,2,'Unspecified DEC','Unspecified DEC');
commit;


insert into de_conc (item_id, ver_nr, CONC_DOM_ITEM_ID,CONC_DOM_VER_NR, OBJ_CLS_ITEM_ID, OBJ_CLS_VER_NR,PROP_ITEM_ID,  PROP_VER_NR, LST_UPD_DT)
...
insert into value_dom (item_id, ver_nr, CONC_DOM_ITEM_ID,CONC_DOM_VER_NR, LST_UPD_DT)
select -20004, 1,-20002, 1, sysdate from dual;
commit;

insert into de (item_id, ver_nr, VAL_DOM_ITEM_ID,VAL_DOM_VER_NR, DE_CONC_ITEM_ID, DE_CONC_VER_NR, LST_UPD_DT)
...
/
create or replace procedure sp_create_csi_2
as
v_cnt integer;
begin
...
ac.origin,
ac.preferred_definition,
nvl(ac.long_name, ac.preferred_name), ac.public_id,
--stewa_idseq,
ac.unresolved_issue,
ac.version,
ac.created_by, ac.date_created,
...
delete from nci_admin_item_rel where rel_typ_id in (61,60);
commit;
...
insert /*+ APPEND */  into nci_admin_item_rel_alt_key
(P_ITEM_ID, P_ITEM_VER_NR, C_ITEM_ID, C_ITEM_VER_NR, 
--CNTXT_ITEM_ID, CNTXT_VER_NR, 
...
/
create or replace procedure sp_create_pv_2
as
v_cnt integer;
begin
