...
-- Added User drop down columns, program area, status sort order
...
-- Added CS and Parent CSI Long Name
...
-- For performance, changing view to table. As it is already used everywhere in OneData, used the same view name

  CREATE TABLE VW_CNTXT 
   (	ITEM_ID NUMBER NOT NULL ENABLE, 
	...
	CURRNT_VER_IND NUMBER(1,0) NOT NULL ENABLE, 
	REGSTR_STUS_NM_DN VARCHAR2(50 BYTE), 
	ADMIN_STUS_NM_DN VARCHAR2(50 BYTE), 
	CREAT_DT DATE, 
	CREAT_USR_ID VARCHAR2(50 BYTE), 
	LST_UPD_USR_ID VARCHAR2(50 BYTE), 
	FLD_DELETE NUMBER(1,0), 
	LST_DEL_DT DATE, 
	S2P_TRN_DT DATE, 
	LST_UPD_DT DATE NOT NULL ENABLE, 
	NCI_PRG_AREA_ID NUMBER,
