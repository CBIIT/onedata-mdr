...
END;
/
GRANT EXECUTE, DEBUG ON  GET_CONCEPTS2  TO ONEDATA_RO;
/
...
END;
/
GRANT EXECUTE, DEBUG ON  GET_CONCEPTS_PRN  TO ONEDATA_RO;
/
...
END;
/
GRANT EXECUTE, DEBUG ON  GET_CONCEPT_ORIGIN  TO ONEDATA_RO;
/
...
/
CREATE OR REPLACE TYPE CDEBROWSER_DEC_T      FORCE     AS OBJECT
 ("PublicId"      NUMBER,
  "PreferredName"          VARCHAR2 (30),
  "PreferredDefinition"    VARCHAR2 (4000),
  "LongName"     VARCHAR2(255),
...
--and ai.item_ID between 60001 and 90001
...
/
GRANT SELECT ON DE_CDE1_XML_GENERATOR_VW TO ONEDATA_RO;
/
GRANT SELECT ON CDE_19_GENERATED_XML TO ONEDATA_RO;
/
GRANT SELECT ON CDE_19_REPORTS_ERR_LOG TO ONEDATA_RO;
/
GRANT SELECT ON VW_CNCPT_19 TO ONEDATA_RO;
/
GRANT SELECT ON DE_CDE1_XML_GENERATOR_749VW TO ONEDATA_RO;
/
GRANT SELECT ON CDEBROWSER_COMPLEX_DE_VIEW_N TO ONEDATA_RO;
/
GRANT SELECT ON CDEBROWSER_CS_VIEW_N TO ONEDATA_RO;
/
GRANT SELECT ON CDEBROWSER_DE_DEC_VIEW TO ONEDATA_RO;
/
GRANT EXECUTE, DEBUG ON  CDEBROWSER_VD_T749  TO ONEDATA_RO;
/
GRANT EXECUTE, DEBUG ON  CDEBROWSER_DEC_T  TO ONEDATA_RO;
/
GRANT EXECUTE, DEBUG ON  DERIVED_DATA_ELEMENT_T  TO ONEDATA_RO;
/
GRANT EXECUTE, DEBUG ON  DATA_ELEMENT_DERIVATION_LIST_T  TO ONEDATA_RO;
/
GRANT EXECUTE, DEBUG ON  DATA_ELEMENT_DERIVATION_T TO ONEDATA_RO;
/
GRANT EXECUTE, DEBUG ON  CDEBROWSER_RD_LIST_T   TO ONEDATA_RO;
/
GRANT EXECUTE, DEBUG ON  CDEBROWSER_RD_T  TO ONEDATA_RO;
/
GRANT EXECUTE, DEBUG ON  CDEBROWSER_CSI_LIST_T   TO ONEDATA_RO; 
/
GRANT EXECUTE, DEBUG ON  CDEBROWSER_CSI_T    TO ONEDATA_RO;
/
GRANT EXECUTE, DEBUG ON  DE_VALID_VALUE_LIST_T    TO ONEDATA_RO;   
/
GRANT EXECUTE, DEBUG ON  DE_VALID_VALUE_T     TO ONEDATA_RO;
/
GRANT EXECUTE, DEBUG ON  MDSR_749_PV_VD_LIST_T  TO ONEDATA_RO;
/
GRANT EXECUTE, DEBUG ON  MDSR_749_PV_VD_ITEM_T    TO ONEDATA_RO;         
/
GRANT EXECUTE, DEBUG ON  MDSR_749_ALTERNATENAM_LIST_T   TO ONEDATA_RO;
/
GRANT EXECUTE, DEBUG ON  MDSR_749_ALTERNATENAME_ITEM_T    TO ONEDATA_RO;

GRANT EXECUTE, DEBUG ON  CDEBROWSER_ALTNAME_LIST_T    TO ONEDATA_RO;
/
GRANT EXECUTE, DEBUG ON  CDEBROWSER_ALTNAME_T2   TO ONEDATA_RO;   
/
GRANT EXECUTE, DEBUG ON  ADMIN_COMPONENT_WITH_CON_T    TO ONEDATA_RO;     
/
GRANT EXECUTE, DEBUG ON  ADMIN_COMPONENT_WITH_ID_LN_T    TO ONEDATA_RO;    
/
GRANT EXECUTE, DEBUG ON  ADMIN_COMPONENT_WITH_ID_T     TO ONEDATA_RO;
/
GRANT EXECUTE, DEBUG ON  CONCEPTS_LIST_T  TO ONEDATA_RO;
/
GRANT EXECUTE, DEBUG ON  CONCEPT_DETAIL_T  TO ONEDATA_RO;
/
