...
if (v_disp_ord < 0) then  -- calling from Copy Hodule hook
    ...
    for curmod in (select * from nci_admin_item_rel where c_item_id = v_from_module_id and c_item_ver_nr = v_from_module_ver and rel_typ_id = 61 and
    p_item_id = v_from_form_id and p_item_ver_nr = v_from_form_ver) loop
