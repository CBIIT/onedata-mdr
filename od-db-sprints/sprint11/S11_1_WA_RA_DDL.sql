...
CREATE UNIQUE INDEX ONEDATA_WA.IDX_NCI_QUEST_VV_IDSEQ ON ONEDATA_WA.NCI_QUEST_VALID_VALUE
(NCI_IDSEQ);
CREATE UNIQUE INDEX ONEDATA_WA.IDXQUESTVV ON ONEDATA_WA.NCI_QUEST_VALID_VALUE
(NCI_PUB_ID);
CREATE INDEX ONEDATA_WA.IDX_NCI_QUEST_VV ON ONEDATA_WA.NCI_QUEST_VALID_VALUE
(Q_PUB_ID, Q_VER_NR);
...
create ore replace view VW_CNCPT 
  AS
...
nvl(ADMIN_ITEM.DEF_SRC, 'No Def Source'), OBJ_KEY.OBJ_KEY_DESC EVS_SRC
