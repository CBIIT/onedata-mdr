CREATE INDEX IDX_NCI_ADMIN_ITEM_REL_C ON NCI_ADMIN_ITEM_REL (C_ITEM_ID,C_ITEM_VER_NR);
ALTER TABLE  NCI_FORM_TA_REL  MODIFY (TA_ID NOT NULL,NCI_PUB_ID NOT NULL,NCI_VER_NR NOT NULL);
...
FROM ADMIN_ITEM, NCI_ADMIN_ITEM_EXT ext
  ...
  select  ak.CREAT_DT, ak.CREAT_USR_ID, ak.LST_UPD_USR_ID, ak.LST_UPD_DT, ak.S2P_TRN_DT, ak.LST_DEL_DT, ak.FLD_DELETE,
ai.ITEM_NM, ai.ITEM_LONG_NM, ai.ITEM_ID, ai.VER_NR, ai.ITEM_DESC, ai.CNTXT_NM_DN, ai.ADMIN_STUS_NM_DN, ai.REGSTR_STUS_NM_DN, ak.P_ITEM_ID, ak.P_ITEM_VER_NR, ai.CNTXT_ITEM_ID,
ai.CNTXT_VER_NR, ai.ADMIN_STUS_ID, ai.REGSTR_STUS_ID, ak.CREAT_USR_ID  CREAT_USR_ID_X, ak.LST_UPD_USR_ID LST_UPD_USR_ID_X
from NCI_ADMIN_ITEM_REL ak, ADMIN_ITEM ai
where ak.C_ITEM_ID  = ai.ITEM_ID and ak.C_ITEM_VER_NR  = ai.VER_NR and ai.ADMIN_ITEM_TYP_ID = 4
union
  select  ak.CREAT_DT, ak.CREAT_USR_ID, ak.LST_UPD_USR_ID, ak.LST_UPD_DT, ak.S2P_TRN_DT, ak.LST_DEL_DT, ak.FLD_DELETE,
ai.ITEM_NM, ai.ITEM_LONG_NM, ai.ITEM_ID, ai.VER_NR, ai.ITEM_DESC, ai.CNTXT_NM_DN, ai.ADMIN_STUS_NM_DN, ai.REGSTR_STUS_NM_DN, csi.CS_ITEM_ID, csi.CS_ITEM_VER_NR, ai.CNTXT_ITEM_ID,
ai.CNTXT_VER_NR, ai.ADMIN_STUS_ID, ai.REGSTR_STUS_ID, ak.CREAT_USR_ID  CREAT_USR_ID_X, ak.LST_UPD_USR_ID LST_UPD_USR_ID_X
from NCI_ADMIN_ITEM_REL ak, ADMIN_ITEM ai, NCI_CLSFCTN_SCHM_ITEM csi
where ak.C_ITEM_ID  = ai.ITEM_ID and ak.C_ITEM_VER_NR  = ai.VER_NR and ai.ADMIN_ITEM_TYP_ID = 4 and ak.P_ITEM_ID = csi.ITEM_ID and ak.P_ITEM_VER_NR = csi.VER_NR;
