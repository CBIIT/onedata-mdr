...
begin
spLoadDataAudit(sysdate -2, sysdate);
...
delete from nci_data_audt where creat_dt_audt >= v_start_dt and creat_dt_audt <= v_end_dt and ACTION_TYP not in ( 'M','X','Y','Z');
commit;
...
LST_UPD_USR_ID_AUDT, CREAT_DT_AUDT, LST_UPD_DT_AUDT, obj_id, tbl_nm, AUDT_DESC)
...
CREAT_USR_ID, CREAT_USR_ID, CREAT_DT , CREAT_DT, obj_id, tbl_nm, AUDT_DESC
...
UPD_COL_NEW_VAL,  a.CREAT_USR_ID, a.CREAT_USR_ID, a.CREAT_DT , a.CREAT_DT,obj_id, tbl_nm, AUDT_DESC
...
decode(TRNS_TYP, 'U', UPD_COL_NEW_VAL,REF_NM),  a.CREAT_USR_ID, a.CREAT_USR_ID, a.CREAT_DT , a.CREAT_DT,obj_id, tbl_nm, AUDT_DESC
...
a.CREAT_USR_ID, a.CREAT_USR_ID, a.CREAT_DT , a.CREAT_DT,obj_id, tbl_nm, AUDT_DESC
...
from onedata_md.od_md_data_audt where tbl_nm = 'NCI_ADMIN_ITEM_REL' and pk_ref like '%P_ITEM_ID%' and 
creat_dt >= sysdate - 7 and creat_dt <= sysdate;
commit;
...
-1,1,
substr(PK_REF, instr(pk_ref,'REL_TYP_ID')+11,instr(substr(pk_ref,instr(pk_ref,'REL_TYP_ID')+11), '#')-1)
from onedata_md.od_md_data_audt where tbl_nm = 'NCI_ADMIN_ITEM_REL' and pk_ref not like '%P_ITEM_ID%' and 
creat_dt >= sysdate - 7 and creat_dt <= sysdate;
commit;
...
insert into nci_data_audt (item_id, ver_nr, --ADMIN_ITEM_TYP_ID, 
ACTION_TYP, LVL, LVL_PK, ATTR_NM, FROM_VAL, TO_VAL, CREAT_USR_ID_AUDT,
LST_UPD_USR_ID_AUDT, CREAT_DT_AUDT, LST_UPD_DT_AUDT, AUDT_CMNTS, obj_id, AUDT_DESC)
...
LVL_1_ITEM_ID,LVL_1_VER_NR,LVL_1_ITEM_NM, LVL_1_DISP_ORD, obj_id, AUDT_DESC)
...
--decode(TRNS_TYP, 'U', UPD_COL_NEW_VAL,REF_NM), 
a.CREAT_USR_ID, a.CREAT_USR_ID, a.CREAT_DT , a.CREAT_DT,
a.c_item_id, a.c_item_id, a.c_item_ver_nr, ai.item_nm, an.DISP_ORD, obj_id, AUDT_DESC
...
insert into nci_data_audt (item_id, ver_nr, --ADMIN_ITEM_TYP_ID, 
ACTION_TYP, LVL, LVL_PK, ATTR_NM, FROM_VAL, TO_VAL, CREAT_USR_ID_AUDT,
LST_UPD_USR_ID_AUDT, CREAT_DT_AUDT, LST_UPD_DT_AUDT, obj_id, AUDT_DESC)
select an.item_id,an.ver_nr, TRNS_TYP, 'Concept Relationship', PK_REF,UPD_COL_NM, UPD_COL_OLD_VAL,
 UPD_COL_NEW_VAL,  a.CREAT_USR_ID, a.CREAT_USR_ID, a.CREAT_DT , a.CREAT_DT, obj_id, AUDT_DESC
...
LVL_2_ITEM_ID, LVL_2_VER_NR, LVL_2_ITEM_NM, LVL_2_DISP_ORD, obj_id, AUDT_DESC)
select m.p_item_id,m.p_item_ver_nr, TRNS_TYP, 'Form Question', PK_REF,UPD_COL_NM, UPD_COL_OLD_VAL,
 ...
 q.c_item_id, q.c_item_ver_nr, q.item_long_nm, q.DISP_ORD, obj_id, AUDT_DESC
...
LVL_3_ITEM_ID, LVL_3_VER_NR, LVL_3_ITEM_NM, LVL_3_DISP_ORD, obj_id, AUDT_DESC
)
select m.p_item_id,m.p_item_ver_nr, TRNS_TYP, 'Form Question Valid Values', PK_REF,UPD_COL_NM, UPD_COL_OLD_VAL,
 ...
 vv.nci_pub_id, vv.nci_ver_nr, vv.value, vv.DISP_ORD, obj_id, AUDT_DESC
