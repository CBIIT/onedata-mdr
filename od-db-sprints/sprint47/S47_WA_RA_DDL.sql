...
alter table NCI_STG_FORM_QUEST_IMPORT add SRC_MOD_INSTR varchar2(4000);
  ...
  CREATE TABLE "ONEDATA_WA"."NCI_STG_FORM_IMPORT" 
   (	"FORM_IMP_ID" NUMBER NOT NULL ENABLE, 
	"SRC_FORM_NM" VARCHAR2(255 BYTE) COLLATE "USING_NLS_COMP", 
	"CTL_VAL_STUS" VARCHAR2(50 BYTE) COLLATE "USING_NLS_COMP", 
	"CTL_VAL_MSG" VARCHAR2(4000 BYTE) COLLATE "USING_NLS_COMP", 
	"FORM_NM" VARCHAR2(255 BYTE) COLLATE "USING_NLS_COMP", 
	"CNTXT_ITEM_ID" NUMBER, 
	"CNTXT_VER_NR" NUMBER(4,2), 
	"PROCESS_DT" VARCHAR2(20 BYTE) COLLATE "USING_NLS_COMP", 
	...
	"CREATED_FORM_ITEM_ID" NUMBER, 
	"LST_UPD_DT_CHAR" VARCHAR2(20 BYTE) COLLATE "USING_NLS_COMP", 
	"PRTCL_ITEM_ID" NUMBER, 
	"PRTCL_VER_NR" NUMBER(4,2), 
	"IMP_PRTCL_NM" VARCHAR2(30 BYTE) COLLATE "USING_NLS_COMP", 
	"DT_SORT" TIMESTAMP (2) DEFAULT sysdate, 
	 PRIMARY KEY ("FORM_IMP_ID")
