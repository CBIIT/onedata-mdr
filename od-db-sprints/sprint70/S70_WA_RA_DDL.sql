...
create or replace view vw_NCI_MODULE_DE_SHORT as SELECT distinct FRM.ITEM_LONG_NM FRM_ITEM_LONG_NM, FRM.ITEM_NM FRM_ITEM_NM, FRM.ITEM_ID FRM_ITEM_ID, FRM.VER_NR FRM_VER_NR,  FRM.CNTXT_NM_DN FRM_CNTXT_NM_DN,
...
AIR.C_ITEM_ID DE_ITEM_ID, AIR.C_ITEM_VER_NR DE_VER_NR, 
--AIR.DISP_ORD QUEST_DISP_ORD,FRM_MOD.DISP_ORD MOD_DISP_ORD,
...
AND FRM.ADMIN_ITEM_TYP_ID IN ( 54,55)
	and frm_mod.c_item_id = air.p_item_id
	and frm_mod.c_item_ver_nr = air.p_item_ver_nr;
...
--jira 9145
  CREATE OR REPLACE FORCE EDITIONABLE VIEW VW_MDL_MAP_RSLT_SHRT("MDL_MAP_ITEM_ID", "MDL_MAP_VER_NR", "MEC_MAP_NM", "SORT_ORD", "TGT_MEC_PHY_NM", "TGT_ME_PHY_NM", "SRC_ME_PHY_NM", "SRC_MEC_PHY_NM", "TGT_VAL_DOM_TYP", "SRC_VAL_DOM_TYP", "TGT_CDE_ITEM_ID", "TGT_CDE_VER_NR", "SRC_CDE_ITEM_ID", "SRC_CDE_VER_NR", "MEC_MAP_NOTES", "TRNS_DESC_TXT", "TRANS_RUL_NOT", "PCODE_SYSGEN", "VALID_PLTFORM", "PROV_ORG_ID", "PROV_CNTCT_ID", "PROV_RSN_TXT", "PROV_TYP_RVW_TXT", "PROV_RVW_DT", "PROV_APRV_DT", "CMNTS_DESC_TXT", "CREAT_DT", "CREAT_USR_ID", "LST_UPD_DT", "LST_UPD_USR_ID", "CREAT_DT_X", "CREAT_USR_ID_X", "LST_UPD_DT_X", "LST_UPD_USR_ID_X", "FLD_DELETE", "S2P_TRN_DT", "LST_DEL_DT", "MAP_DEG", "CTL_VAL_MSG") DEFAULT COLLATION "USING_NLS_COMP"  AS 
...
alter table nci_ds_rslt modify SCORE number(38,2);
