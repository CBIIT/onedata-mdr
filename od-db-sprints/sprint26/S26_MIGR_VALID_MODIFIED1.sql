...
END;
/
create or replace PROCEDURE  SAG_AI_VALIDATION (VALID_TYPE VARCHAR2 DEFAULT 'MIGRATE')
AS
    -- VALID_TYPE validation type, default 'MIGRATE', another oprion 'REVERSE'
    --DECLARE
...
END;
/
create or replace PROCEDURE  SAG_AI_VALIDATION_REV (VALID_TYPE VARCHAR2 DEFAULT 'MIGRATE')
AS
    -- VALID_TYPE validation type, default 'MIGRATE', another oprion 'REVERSE'
    --DECLARE
