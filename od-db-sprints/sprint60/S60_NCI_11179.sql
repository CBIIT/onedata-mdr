...
/* Model Map */
 if v_admin_item.admin_item_typ_id = 58 then -- Add Mapping and Value Mapping
        action_rows := t_rows();
        nci_codemap.spCopyMM(v_admin_item.item_id, v_admin_item.ver_nr, v_admin_item.item_id, v_version,v_user_id, 0);
        nci_codemap.spCopyVM(v_admin_item.item_id, v_admin_item.ver_nr, v_admin_item.item_id, v_version,v_user_id, 0);
