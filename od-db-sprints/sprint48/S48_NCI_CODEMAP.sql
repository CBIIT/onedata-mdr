...
and mec1.de_conc_item_id not in (select mec2.de_conc_item_id from 
...
and mm2.item_id  = ihook.getColumnValue(row_ori, 'ITEM_ID') and mm2.ver_nr = ihook.getColumnValue (row_ori,'VER_NR') ) or mec1.de_conc_item_id is null
) loop
