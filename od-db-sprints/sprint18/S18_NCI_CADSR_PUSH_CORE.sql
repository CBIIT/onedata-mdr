...
(select  ai.ADMIN_STUS_NM_DN, ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq, ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'Yes',0,'No'),
            ai.ITEM_NM, ai.ORIGIN,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_Nm,  ai.def_src,
...
select  ai.NCI_IDSEQ, ai.ADMIN_STUS_NM_DN,ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq,ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'Yes',0,'No'),
            ai.ITEM_NM, ai.ORIGIN,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_Nm,ai.ITEM_ID, ai.NCI_IDSEQ,ai.VER_NR,ai.def_src,
...
update sbr.administered_components set ( asl_name,begin_date,change_note,conte_idseq,end_date,latest_version_ind,
            ...
            date_modified, modified_by, deleted_ind) =
(select  ai.ADMIN_STUS_NM_DN,ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq,ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'Yes',0,'No'),
            ai.ITEM_NM, ai.origin,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_NM, 
            ai.LST_UPD_DT,ai.LST_UPD_USR_ID, decode(nvl(ai.fld_delete,0),0,'No',1,'Yes')
    from admin_item ai, admin_item c
    where ai.cntxt_item_id = c.item_id and ai.cntxt_ver_nr = c.ver_nr
        and ai.nci_idseq = vIdseq)
...
select  ai.NCI_IDSEQ, ai.ADMIN_STUS_NM_DN,ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq,ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'Yes',0,'No'),
            ai.ITEM_NM, ai.ORIGIN,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_NM,ai.ITEM_ID,  ai.VER_NR,
...
insert into sbr.ac_registrations (ac_idseq, registration_status)
select vIdSeq, nci_stus from stus_mstr, admin_item ai where stus_typ_id = 1 and stus_id = ai.regstr_stus_id 
...
(select  ai.ADMIN_STUS_NM_DN,ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq,ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'Yes',0,'No'),
            ai.ITEM_NM, ai.ORIGIN,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_NM,   dec.nci_idseq, vd.nci_idseq,
...
select  ai.NCI_IDSEQ, ai.ADMIN_STUS_NM_DN,ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq,ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'Yes',0,'No'),
            ai.ITEM_NM, ai.ORIGIN,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_NM,ai.ITEM_ID, ai.VER_NR, dec.nci_idseq, vd.nci_idseq,
...
update  sbr.data_element_concepts  set ( asl_name,begin_date,change_note,conte_idseq,end_date,latest_version_ind,
            ...
            date_modified, modified_by, deleted_ind) =
(select  ai.ADMIN_STUS_NM_DN,ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq,ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'Yes',0,'No'),
            ai.ITEM_NM, ai.ORIGIN,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_NM, oc.nci_idseq, prop.nci_idseq, cd.nci_idseq ,
            ai.LST_UPD_DT,ai.LST_UPD_USR_ID,decode(nvl(ai.fld_delete,0),0,'No',1,'Yes')
...
insert into sbr.data_element_concepts (dec_idseq, asl_name,begin_date,change_note,conte_idseq,end_date,latest_version_ind,
            ...
            created_by, date_created,date_modified, modified_by, deleted_ind)
select  ai.NCI_IDSEQ, ai.ADMIN_STUS_NM_DN,ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq,ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'Yes',0,'No'),
            ai.ITEM_NM, ai.ORIGIN,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_NM,ai.ITEM_ID, oc.nci_idseq, prop.nci_idseq, cd.nci_idseq,ai.VER_NR, 
            ai.CREAT_USR_ID, ai.CREAT_DT, ai.LST_UPD_DT,ai.LST_UPD_USR_ID ,decode(nvl(ai.fld_delete,0),0,'No',1,'Yes')
        from admin_item ai, admin_item c, de_conc dec, admin_item oc, admin_item prop, admin_item cd
        where ai.cntxt_item_id = c.item_id and ai.cntxt_ver_nr = c.ver_nr
            and ai.nci_idseq = vIdseq 
...
(select  ai.ADMIN_STUS_NM_DN,ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq,ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'Yes',0,'No'),
            ai.ITEM_NM, ai.ORIGIN,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_Nm, ok.NCI_CD,  ai.def_src,
...
select  ai.NCI_IDSEQ, ai.ADMIN_STUS_NM_DN,ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq,ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'Yes',0,'No'),
            ai.ITEM_NM, ai.ORIGIN,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_Nm,ai.ITEM_ID, ok.nci_cd, ai.def_src,ai.VER_NR, 
...
update sbr.value_domains set ( asl_name,begin_date,change_note,conte_idseq,end_date,latest_version_ind,
                ...
                date_modified, modified_by, deleted_ind) =
(select  ai.ADMIN_STUS_NM_DN,ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq,ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'Yes',0,'No'),
                ai.ITEM_NM, ai.ORIGIN,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_NM,  VAL_DOM_HIGH_VAL_NUM,VAL_DOM_LOW_VAL_NUM,VAL_DOM_MAX_CHAR,VAL_DOM_MIN_CHAR,
...
insert into sbr.value_domains (vd_idseq, asl_name,begin_date,change_note,conte_idseq,end_date,latest_version_ind,
            ...
            created_by, date_created,date_modified, modified_by, deleted_ind)
select  ai.NCI_IDSEQ, ai.ADMIN_STUS_NM_DN,ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq,ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'Yes',0,'No'),
            ai.ITEM_NM, ai.ORIGIN,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_NM,ai.ITEM_ID, 
...
update sbr.conceptual_domains set ( asl_name,begin_date,change_note,conte_idseq,end_date,latest_version_ind,
            ...
            date_modified, modified_by, deleted_ind) =
(select  ai.ADMIN_STUS_NM_DN,ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq,ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'Yes',0,'No'),
            ai.ITEM_NM, ai.ORIGIN,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_Nm, DIMNSNLTY, 
            ai.LST_UPD_DT,ai.LST_UPD_USR_ID ,decode(nvl(ai.fld_delete,0),0,'No',1,'Yes')
...
insert into sbr.conceptual_domains (cd_idseq, asl_name,begin_date,change_note,conte_idseq,end_date,latest_version_ind,
            ...
            created_by, date_created,date_modified, modified_by, deleted_ind)
select  ai.NCI_IDSEQ, ai.ADMIN_STUS_NM_DN,ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq,ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'Yes',0,'No'),
            ai.ITEM_NM, ai.ORIGIN,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_Nm,ai.ITEM_ID, ai.VER_NR,DIMNSNLTY, 
            ai.CREAT_USR_ID, ai.CREAT_DT, ai.LST_UPD_DT,ai.LST_UPD_USR_ID ,decode(nvl(ai.fld_delete,0),0,'No',1,'Yes')
        from admin_item ai, admin_item c, conc_dom cd
        where ai.cntxt_item_id = c.item_id and ai.cntxt_ver_nr = c.ver_nr
        and c.admin_item_typ_id = 8
...
update sbrext.protocols_ext set ( asl_name,begin_date,change_note,conte_idseq,end_date,latest_version_ind,
            ...
            date_modified, modified_by, deleted_ind) =
(select  ai.ADMIN_STUS_NM_DN,ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq,ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'YES',0,'NO'),
            ai.ITEM_NM, ai.ORIGIN,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_Nm, CHNG_TYP,	CHNG_NBR,	RVWD_DT,	RVWD_USR_ID, APPRVD_DT,	APPRVD_USR_ID, ok.nci_cd,
...
insert into sbrext.protocols_ext (proto_idseq, asl_name,begin_date,change_note,conte_idseq,end_date,latest_version_ind,
            ...
            created_by, date_created,date_modified, modified_by, deleted_ind)
select  ai.NCI_IDSEQ, ai.ADMIN_STUS_NM_DN,ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq,ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'Yes',0,'No'),
            ai.ITEM_NM, ai.ORIGIN,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_Nm,ai.ITEM_ID, ok.nci_cd, 	CHNG_TYP,	CHNG_NBR,	RVWD_DT,	RVWD_USR_ID, APPRVD_DT,	APPRVD_USR_ID,ai.VER_NR, 
           PROTCL_ID,  org.ORG_NM,  PROTCL_PHASE,
            ai.CREAT_USR_ID, ai.CREAT_DT, ai.LST_UPD_DT,ai.LST_UPD_USR_ID ,decode(nvl(ai.fld_delete,0),0,'No',1,'Yes')
...
update sbrext.value_meanings set ( asl_name,begin_date,change_note,conte_idseq,end_date,latest_version_ind,
            ...
            date_modified, modified_by, deleted_ind) =
(select  ai.ADMIN_STUS_NM_DN,ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq,ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'Yes',0,'No'),
            ai.ITEM_NM, ai.ORIGIN,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_Nm, vm_desc_txt, vm_cmnts,ai.nci_idseq,ai.DEF_SRC,
            ai.LST_UPD_DT,ai.LST_UPD_USR_ID ,decode(nvl(ai.fld_delete,0),0,'No',1,'Yes')
...
insert into sbr.value_meanings (vm_idseq, asl_name,begin_date,change_note,conte_idseq,end_date,latest_version_ind,
            ...
            created_by, date_created,date_modified, modified_by, deleted_ind)
select  ai.NCI_IDSEQ, ai.ADMIN_STUS_NM_DN,ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq,ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'Yes',0,'No'),
            ai.ITEM_NM, ai.ORIGIN,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_Nm,ai.ITEM_ID, vm_desc_txt, vm_cmnts ,ai.VER_NR, ai.nci_idseq,ai.DEF_SRC,
            ai.CREAT_USR_ID, ai.CREAT_DT, ai.LST_UPD_DT,ai.LST_UPD_USR_ID ,decode(nvl(ai.fld_delete,0),0,'No',1,'Yes')
        from admin_item ai, admin_item c, NCI_val_mean con
        where ai.cntxt_item_id = c.item_id and ai.cntxt_ver_nr = c.ver_nr
            and c.admin_item_typ_id = 8
...
(select  ai.ADMIN_STUS_NM_DN,ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq,ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'Yes',0,'No'),
            ai.ITEM_NM, ai.ORIGIN,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_Nm, ai.LST_UPD_DT,ai.LST_UPD_USR_ID,
...
update sbr.cs_items set ( asl_name,begin_date,change_note,conte_idseq,end_date,latest_version_ind,
            ...
            date_modified, modified_by, deleted_ind) =
(select  ai.ADMIN_STUS_NM_DN,ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq,ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'Yes',0,'No'),
            ai.ITEM_NM, ai.ORIGIN,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_Nm, ok.NCI_CD,  csi_desc_txt, csi_cmnts,
            ai.LST_UPD_DT,ai.LST_UPD_USR_ID ,decode(nvl(ai.fld_delete,0),0,'No',1,'Yes')
...
insert into sbr.cs_items (csi_idseq, asl_name,begin_date,change_note,conte_idseq,end_date,latest_version_ind,
            ...
            created_by, date_created,date_modified, modified_by, deleted_ind)
select  ai.NCI_IDSEQ, ai.ADMIN_STUS_NM_DN,ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq,ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'Yes',0,'No'),
            ai.ITEM_NM, ai.ORIGIN,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_Nm,ai.ITEM_ID, ok.nci_cd, csi_desc_txt, csi_cmnts,ai.VER_NR, 
            ai.CREAT_USR_ID, ai.CREAT_DT, ai.LST_UPD_DT,ai.LST_UPD_USR_ID ,decode(nvl(ai.fld_delete,0),0,'No',1,'Yes')
...
and csi.p_item_id = pcsiai.item_id and csi.p_item_ver_nr = pcsiai.ver_nr and csi.p_item_id = pcsi.item_id and csi.p_item_ver_nr = pcsi.ver_nr 
and csi.p_item_id is not null) loop
insert into  sbr.cs_csi (CS_CSI_IDSEQ, CS_IDSEQ,csi_idseq, P_CS_CSI_IDSEQ,  DATE_CREATED, CREATED_BY, DATE_MODIFIED, MODIFIED_BY) 
values (cur.cs_csi_idseq, cur.cs_idseq, cur.csi_idseq, cur.p_cs_csi_idseq, cur.creat_dt,
cur.creat_usr_id, cur.lst_upd_dt, cur.lst_upd_usr_id);
...
csiai.nci_idseq = vIdSeq and csi.item_id = vItemid and csi.ver_nr = vVerNr and csi.cs_item_id = cs.item_id and csi.cs_item_ver_nr = cs.ver_nr
and csi.p_item_id is null) loop
insert into  sbr.cs_csi (CS_CSI_IDSEQ, CS_IDSEQ, csi_idseq, DATE_CREATED, CREATED_BY, DATE_MODIFIED, MODIFIED_BY) values (cur.cs_csi_idseq, cur.cs_idseq, cur.csi_idseq, cur.creat_dt,
cur.creat_usr_id, cur.lst_upd_dt, cur.lst_upd_usr_id);
end loop;
end if;
end if;
...
select ai.nci_idseq,  substr(ai.ITEM_DESC,1,2000), ai.ITEM_Nm, ai.VER_NR, ok.nci_cd, 'UNASSIGNED'
...
update sbr.classification_schemes set ( asl_name,begin_date,change_note,conte_idseq,end_date,latest_version_ind,
            ...
            date_modified, modified_by, deleted_ind) =
(select  ai.ADMIN_STUS_NM_DN,ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq,ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'Yes',0,'No'),
            ai.ITEM_NM, ai.ORIGIN,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_Nm,  ok.nci_cd, nci_label_typ_flg, 
            ai.LST_UPD_DT,ai.LST_UPD_USR_ID ,decode(nvl(ai.fld_delete,0),0,'No',1,'Yes')
...
insert into sbr.classification_schemes (cs_idseq, asl_name,begin_date,change_note,conte_idseq,end_date,latest_version_ind,
            ...
            created_by, date_created,date_modified, modified_by, deleted_ind)
select  ai.NCI_IDSEQ, ai.ADMIN_STUS_NM_DN,ai.EFF_DT, ai.ADMIN_NOTES, c.nci_idseq,ai.UNTL_DT, decode(ai.CURRNT_VER_IND,1,'Yes',0,'No'),
            ai.ITEM_NM, ai.ORIGIN,substr(ai.ITEM_DESC,1,2000),ai.ITEM_LONG_Nm,ai.ITEM_ID, ai.VER_NR, ok.nci_cd, nci_label_typ_flg, 
            ai.CREAT_USR_ID, ai.CREAT_DT, ai.LST_UPD_DT,ai.LST_UPD_USR_ID ,decode(nvl(ai.fld_delete,0),0,'No',1,'Yes')
        from admin_item ai, admin_item c, clsfctn_schm cs, obj_key ok
        where ai.cntxt_item_id = c.item_id and ai.cntxt_ver_nr = c.ver_nr
        and c.admin_item_typ_id = 8
