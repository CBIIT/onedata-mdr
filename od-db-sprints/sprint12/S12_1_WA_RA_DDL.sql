...
nvl(decode(ADMIN_ITEM.DEF_SRC, 'NCI', '1-NCI', ADMIN_ITEM.DEF_SRC), 'No Def Source') DEF_SRC, decode(OBJ_KEY.OBJ_KEY_DESC, 'NCI_CONCEPT_CODE', '1-NCI_CONCEPT_CODE', OBJ_KEY.OBJ_KEY_DESC) EVS_SRC
