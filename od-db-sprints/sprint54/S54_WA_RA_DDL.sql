...
drop materialized view vw_cncpt;
  ...
  AS SELECT ADMIN_ITEM.ITEM_ID, ADMIN_ITEM.VER_NR, ADMIN_ITEM.ITEM_NM,  ADMIN_ITEM.ITEM_LONG_NM, ADMIN_ITEM.ITEM_NM ||'.' ITEM_NM_PERIOD,  ADMIN_ITEM.ITEM_LONG_NM || '.' ITEM_LONG_NM_PERIOS, ADMIN_ITEM.ITEM_DESC, ADMIN_ITEM.CREATION_DT, 
