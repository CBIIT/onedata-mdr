...
delete from NCI_STG_ALT_NMS where CTL_VAL_STUS = 'PROCESSED' and LST_UPD_DT < TRUNC ( SYSDATE - 7 );
commit;
delete from NCI_STG_CDE_CREAT where CTL_VAL_STUS = 'PROCESSED' and LST_UPD_DT < TRUNC ( SYSDATE - 7);
commit;
delete from NCI_STG_PV_VM_IMPORT where CTL_VAL_STUS = 'PROCESSED' and LST_UPD_DT < TRUNC ( SYSDATE - 7);
commit;
delete from NCI_STG_FORM_IMPORT where CTL_VAL_STUS = 'PROCESSED' and LST_UPD_DT < TRUNC ( SYSDATE - 7);
commit;
delete from NCI_DS_RSLT where LST_UPD_DT < TRUNC ( SYSDATE - 7);
commit;
