...
procedure spCreateValueMap (input_rows in t_rows, output_rows in out t_rows);
...
procedure spNCIShowPVDependencyCombToDelete (v_data_in in clob, v_data_out out clob);
...
/*  Show PV Details 2 from ADministereds Item */
