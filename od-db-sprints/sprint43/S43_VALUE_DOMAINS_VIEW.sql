...
(VD_IDSEQ, VERSION, PREFERRED_NAME, CONTE_IDSEQ, PREFERRED_DEFINITION, 
 BEGIN_DATE, CONTE_NAME, CONTE_ITEM_ID, CONTE_VER_NR, DTL_NAME, 
 CD_IDSEQ, CONC_DOM_ITEM_ID, CONC_DOM_VER_NR, END_DATE, VD_TYPE, 
 ASL_NAME, CHANGE_NOTE, UOML_NAME, LONG_NAME, FORML_NAME, 
 MAX_LENGTH_NUM, MIN_LENGTH_NUM, HIGH_VALUE_NUM, LOW_VALUE_NUM, DECIMAL_PLACE, 
 LATEST_VERSION_IND, DELETED_IND, CREATED_BY, MODIFIED_BY, DATE_MODIFIED, 
 DATE_CREATED, CHAR_SET_NAME, REP_IDSEQ, ORIGIN, VD_ID, 
 VD_TYPE_FLAG)
BEQUEATH DEFINER
AS 
SELECT ai.NCI_IDSEQ
