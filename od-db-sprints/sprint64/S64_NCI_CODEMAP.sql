create or replace PACKAGE            nci_codemap AS
 ...
 procedure spUpdateModelCDEAssocSub ( v_mdl_id in number, v_mdl_ver_nr in number, v_cnt in out integer);
 ...
 */
 ...
 BEGIN
  ...
  spUpdateModelCDEAssocSub (ihook.getColumnValue(row_ori,'ITEM_ID'),ihook.getColumnValue(row_ori,'VER_NR'), v_cnt);
