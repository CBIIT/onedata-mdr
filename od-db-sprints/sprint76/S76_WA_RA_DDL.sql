...
AND ADMIN_ITEM.VER_NR=VALUE_DOM.VER_NR ;
  ...
  select r.HDR_ID,h.btch_usr_nm, h.btch_nm, h.btch_seq_nbr, entty_nm, entty_nm_usr, cmnts_desc_txt, sys_msg, lst_run_dt, num_cde_mtch, num_dec_mtch, r.ITEM_ID,r.VER_NR,r.RULE_ID,r.SCORE,r.RULE_DESC,r.USR_CMNTS,r.NUM_PV_IN_SRC,r.NUM_PV_IN_CDE,r.NUM_PV_MTCH,r.NM_MTCH_PRCNT,
  ...
  r.MTCH_TYP,r.CDE_PREF_IND,r.SRC_MTCH_ENGN from nci_ds_rslt r, nci_ds_hdr h where r.hdr_id = h.hdr_id and MTCH_TYP_NM = 'CDE'
  union
  select h.hdr_id, h.btch_usr_nm, h.btch_nm,h.btch_seq_nbr, entty_nm, entty_nm_usr, cmnts_desc_txt, sys_msg, lst_run_dt,num_cde_mtch, num_dec_mtch, 17175416, 1, null, null, null, null, null, null, null, null, 
