...
alter table nci_dload_hdr add (	LST_GEN_DT date);
  ...
  CREATE OR REPLACE  VIEW VW_NCI_VD_CNCPT ("ALT_NMS_LVL", "ITEM_ID", "VER_NR", "CORE_ITEM_ID", "CORE_VER_NR", "CNCPT_ITEM_ID", "CNCPT_VER_NR", "CREAT_DT", "CREAT_USR_ID", "LST_UPD_USR_ID", "FLD_DELETE", "LST_DEL_DT", "S2P_TRN_DT", "LST_UPD_DT", "NCI_ORD", "NCI_PRMRY_IND", "NCI_CNCPT_VAL") DEFAULT COLLATION "USING_NLS_COMP"  AS 
  SELECT  'Component Concept' ALT_NMS_LVL, a.ITEM_ID, a.VER_NR,
	a.ITEM_ID CORE_ITEM_ID, a.VER_NR CORE_VER_NR,
		a.CNCPT_ITEM_ID, a.CNCPT_VER_NR, 
		a.CREAT_DT, a.CREAT_USR_ID, a.LST_UPD_USR_ID, 
