...
where admin_item_typ_id = 52 and  nvl(ai.fld_delete,0) = 0 and ai.item_id = r.c_item_id and ai.ver_nr = r.c_item_ver_nr and r.rel_typ_id = 61 and greatest(ai.lst_upd_dt,r.lst_upd_dt) >= sysdate - vHours/24) WA_CNT,
...
(select count(*) from onedata_wa.NCI_ADMIN_ITEM_REL_ALT_KEY
  where REL_TYP_ID=63   and lst_upd_dt >= sysdate - vHours/24 and instr is not null) WA_CNT,
