CREATE OR REPLACE FORCE VIEW VW_NCI_DE
(ITEM_ID, VER_NR, ITEM_ID_STR, ITEM_NM, ITEM_LONG_NM, 
 ITEM_DESC, ADMIN_NOTES, CHNG_DESC_TXT, CREATION_DT, EFF_DT, 
 ORIGIN, ORIGIN_ID, ORIGIN_ID_DN, UNRSLVD_ISSUE, UNTL_DT, 
 CURRNT_VER_IND, REGSTR_STUS_ID, ADMIN_STUS_ID, CNTXT_NM_DN, CNTXT_ITEM_ID, 
 CNTXT_VER_NR, CREAT_USR_ID, CREAT_USR_ID_X, LST_UPD_USR_ID, LST_UPD_USR_ID_X, 
 REGSTR_STUS_DISP_ORD, ADMIN_STUS_DISP_ORD, FLD_DELETE, LST_DEL_DT, S2P_TRN_DT, 
 LST_UPD_DT, CREAT_DT, NCI_IDSEQ, NCI_PRG_AREA_ID, ADMIN_ITEM_TYP_ID, 
 CNTXT_AGG, PREF_QUEST_TXT, SEARCH_STR)
BEQUEATH DEFINER
AS 
