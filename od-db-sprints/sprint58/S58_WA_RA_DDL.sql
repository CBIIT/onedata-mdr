...
alter table NCI_MEC_MAP add (PCODE_SYSGEN varchar2(4000));
  ...
  select
	ai."DATA_ID_STR",ai."ITEM_ID",ai."VER_NR",ai."CLSFCTN_SCHM_ID",
    ai."ITEM_DESC",ai."CNTXT_ITEM_ID",ai."CNTXT_VER_NR",ai."ITEM_LONG_NM",ai."ITEM_NM",ai."ADMIN_NOTES",
    ai."CHNG_DESC_TXT",ai."EFF_DT",ai."ORIGIN",ai."UNRSLVD_ISSUE",ai."UNTL_DT",ai."CLSFCTN_SCHM_VER_NR",ai."ADMIN_ITEM_TYP_ID",
    ...
    ai."ADMIN_STUS_NM_DN",ai."CNTXT_NM_DN",ai."REGSTR_STUS_NM_DN",ai."ORIGIN_ID",ai."ORIGIN_ID_DN",ai."CREAT_USR_ID_X",ai."LST_UPD_USR_ID_X",
    ai."ITEM_NM_CURATED",ai."ITEM_NM_ID_VER", m.prmry_mdl_lang_id ,
