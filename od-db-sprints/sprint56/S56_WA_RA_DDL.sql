...
CREATE OR REPLACE FORCE EDITIONABLE VIEW VW_DE ("ITEM_ID", "VER_NR", "ITEM_NM", "ITEM_LONG_NM", "ITEM_DESC", "CNTXT_NM_DN", "CURRNT_VER_IND", "REGSTR_STUS_NM_DN", "ADMIN_STUS_NM_DN", "REGSTR_STUS_ID", "ADMIN_STUS_ID", "MTCH_TERM", "MTCH_TERM_ADV", "DE_CONC_VER_NR", "DE_CONC_ITEM_ID", "VAL_DOM_VER_NR", "VAL_DOM_ITEM_ID", "REP_CLS_VER_NR", "REP_CLS_ITEM_ID", "CREAT_USR_ID", "LST_UPD_USR_ID", "FLD_DELETE", "LST_DEL_DT", "S2P_TRN_DT", "LST_UPD_DT", "CREAT_DT", "PREF_QUEST_TXT", "NON_ENUM_VAL_DOM_DESC", "DTTYPE_ID", "VAL_DOM_MAX_CHAR", "VAL_DOM_TYP_ID", "UOM_ID", "VAL_DOM_MIN_CHAR", "VAL_DOM_FMT_ID", "CHAR_SET_ID", "VAL_DOM_HIGH_VAL_NUM", "VAL_DOM_LOW_VAL_NUM", "FMT_NM", "DTTYPE_NM", "UOM_NM", "VAL_DOM_TYP") DEFAULT COLLATION "USING_NLS_COMP"  AS 
  SELECT 
ADMIN_ITEM.ITEM_ID, 
ADMIN_ITEM.VER_NR, 
ADMIN_ITEM.ITEM_NM, 
...
and VALUE_DOM.UOM_ID = UOM.UOM_ID (+);
  ...
  GRANT SELECT ON VW_DE TO "ONEDATA_RO";
  GRANT READ ON VW_DE TO "ONEDATA_RO";
