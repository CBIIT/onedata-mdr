...
begin
   ...
   row := t_row();
        ...
        ihook.setColumnValue(row,'ADMIN_ITEM_TYP_ID', 2);
            ...
            --ihook.setColumnValue(row,'ITEM_LONG_NM', nvl(ihook.getColumnValue(rowform,'DEC_ITEM_LONG_NM'),v_id || c_ver_suffix));
         --   if (trim(ihook.getColumnValue(rowform,'DEC_ITEM_LONG_NM')) is null or upper(ihook.getColumnValue(rowform,'DEC_ITEM_LONG_NM')) = 'SYSGEN' or nci_11179_2.isDECnmSysGenNew(trim(ihook.getColumnValue(rowform, 'DEC_ITEM_LONG_NM')))) then
