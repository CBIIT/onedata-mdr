DROP VIEW ONEDATA_WA.CDEBROWSER_CS_VIEW_OLD;

CREATE OR REPLACE FORCE VIEW ONEDATA_WA.CDEBROWSER_CS_VIEW_OLD
(DE_ITEM_ID, DE_VER_NR, CS_ITEM_ID, CS_ITEM_NM, CS_ITEM_LONG_NM, 
 ...
 CSI_LONG_NM, CSITL_NM, CSI_PREF_DEF, CSI_ITEM_ID, CSI_VER_NR, 
 CSI_ITEM_NM)
BEQUEATH DEFINER
AS 
